...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      setProfile({
        ...
        joinDate: 'Março 2025', // pode ajustar com base em uma data real
  ...
  const handleSave = async () => {
    ...
    formData.append("Estado", profile.bio);
  ...
  const recentActivity = [
    { id: 1, type: 'upload', title: 'Nova Música', description: 'Você fez upload de "Nome da Música"', timestamp: '2 horas atrás' },
    { id: 2, type: 'rating', title: 'Nova Avaliação', description: 'Você avaliou o álbum "Nome do Álbum"', timestamp: '1 dia atrás' },
    { id: 3, type: 'group', title: 'Novo Grupo', description: 'Você criou o grupo "Amigos da Música"', timestamp: '2 dias atrás' },
  ];
            ...
            <div className="flex-1">
              {isEditing ? (
                <div className="space-y-4">
                  ...
                  <Input value={profile.location} onChange={(e) => setProfile({ ...profile, location: e.target.value })} placeholder="Localização" />
